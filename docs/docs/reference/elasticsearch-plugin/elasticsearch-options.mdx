...
<MemberInfo kind="property" type={`boolean`} default={`true`}  since="2.2.0"  />
...
<GenerationInfo sourceFile="packages/elasticsearch-plugin/src/options.ts" sourceLine="444" packageName="@vendure-community/elasticsearch-plugin" />
...
<GenerationInfo sourceFile="packages/elasticsearch-plugin/src/options.ts" sourceLine="730" packageName="@vendure-community/elasticsearch-plugin" />
